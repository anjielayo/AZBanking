...
#    Aug 09, 2021 12:09:54 PM WAT  platform: Windows NT
...
import Bank_App_updated2_support
import os.path
...
def vp_start_gui():
    ...
    root = tk.Tk()
    top = Az_Bank(root)
    Bank_App_updated2_support.init(root, top)
    root.mainloop()
...
def create_Az_Bank(rt, *args, **kwargs):
    ...
    w = tk.Toplevel(root)
    top = Az_Bank(w)
    Bank_App_updated2_support.init(w, top, *args, **kwargs)
    return (w, top)
...
The bank will not be held liable for whatsoever issues that might occur as a result of installation of this application.''')
        ...
        self.Authentification_lb.configure(
            text='''An authentification code will be sent to you by E-mail or SMS shortly.''')
        ...
        self.Acc_Fname.place(relx=0.055, rely=0.235, height=21, width=72)
        ...
        self.Acc_BVN.place(relx=0.055, rely=0.518, height=21, width=33)
        ...
        self.Acc_Cus_ID.place(relx=0.055, rely=0.612, height=21, width=72)
        ...
        self.bvn = tk.Entry(self.Account_creation)
        self.bvn.place(relx=0.339, rely=0.518, height=20, relwidth=0.504)
        self.bvn.configure(background="white")
        self.bvn.configure(disabledforeground="#a3a3a3")
        self.bvn.configure(font="TkFixedFont")
        self.bvn.configure(foreground="#000000")
        self.bvn.configure(insertbackground="black")

        self.Customer_ID = tk.Entry(self.Account_creation)
        self.Customer_ID.place(relx=0.339, rely=0.612, height=20, relwidth=0.504)
        ...
        self.Acc_create_save.place(relx=0.348, rely=0.8, height=24, width=67)
        ...
        self.Acc_create_back.place(relx=0.638, rely=0.8, height=24, width=67)
        ...
        self.del_Cust_id.configure(cursor="fleur")
        self.del_Cust_id.configure(disabledforeground="#a3a3a3")
        ...
        self.load_back = tk.Button(self.load_frame)
        ...
        self.show_frame(self.Account_Info_frame)
