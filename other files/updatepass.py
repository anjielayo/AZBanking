...
#    Aug 17, 2021 07:35:07 AM WAT  platform: Windows NT
...
def vp_start_gui():
    ...
    root = tk.Tk()
    top = Toplevel1 (root)
    updatepass_support.init(root, top)
    root.mainloop()
...
def create_Toplevel1(rt, *args, **kwargs):
    ...
    w = tk.Toplevel (root)
    top = Toplevel1 (w)
    updatepass_support.init(w, top, *args, **kwargs)
    return (w, top)
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.update_pass.place(relx=0.2, rely=0.022, relheight=0.944
                , relwidth=0.575)
        ...
        self.update_pass_Label1 = tk.Label(self.update_pass)
        self.update_pass_Label1.place(relx=0.029, rely=0.024, height=41
                , width=84)
        self.update_pass_Label1.configure(background="#d9d9d9")
        self.update_pass_Label1.configure(disabledforeground="#a3a3a3")
        self.update_pass_Label1.configure(foreground="#000000")
        self.update_pass_Label1.configure(text='''Label''')
        ...
        self.update_new_pass_Entry1 = tk.Entry(self.update_pass)
        ...
        self.confirm_new_pass_Entry1_1 = tk.Entry(self.update_pass)
        ...
        self.Save_update_pass = tk.Button(self.update_pass)
        ...
        self.back_update_pass_1 = tk.Button(self.update_pass)
